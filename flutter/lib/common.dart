...
class MyTheme {
  ...
  static const Color accent = Color(0xFF16449B); // کاریا
  static const Color accent50 = Color(0x7716449B);
  static const Color accent80 = Color(0xAA16449B);
  ...
  static ThemeData lightTheme = ThemeData(
    fontFamily: 'Kariya', // kariya-light
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://kariyahesab.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
...
bool whitelistNotEmpty() {
  // https://kariyahesab.comclient-configuration/advanced-settings/#whitelist

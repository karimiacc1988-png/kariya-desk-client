...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("KariyaDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["desk.kariyahesab.com"];
pub const RS_PUB_KEY: &str = "yQh7HGyWBw2sb6SvcKWdXDFgec+a+2oEDLg4QUWh9ic=";
